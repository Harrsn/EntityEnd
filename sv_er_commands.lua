...
-- Command: /restrict [P] A/W/B [Z] | reason
...
function initializeRestriction(admin, targetPly, restrictionLength, curTimeStamp, hasReason, reason, type, typeFlag)
    ...
    if hasReason then 
        file.Write("entityend/"..playerSteamID.."_"..typeFlag..".txt", curTimeStamp.."_"..restrictionLength.."_"..admin:Nick().."_"..reason)
    else 
        file.Write("entityend/"..playerSteamID.."_"..typeFlag..".txt", curTimeStamp.."_"..restrictionLength.."_"..admin:Nick())
    end 
...
function unrestrictVehicles(admin, plyToRestrict)
    ...
    if file.Exists("entityend/"..playerSteamID.."_A.txt", "DATA") then 
        file.Delete("entityend/"..playerSteamID.."_A.txt")
...
function unrestrictWeapons(admin, plyToRestrict)
    ...
    if file.Exists("entityend/"..playerSteamID.."_W.txt", "DATA") then 
        file.Delete("entityend/"..playerSteamID.."_W.txt")
...
function unrestrictBuildtools(admin, plyToRestrict)
    ...
    if file.Exists("entityend/"..playerSteamID.."_B.txt", "DATA") then 
        file.Delete("entityend/"..playerSteamID.."_B.txt")
